...
C {sky130_stdcells/and2_1.sym} 250 170 0 0 {name=x24 VGND=GND VNB=GND VPB=VCC VPWR=VCC prefix=sky130_fd_sc_hd__ }
...
C {vsource.sym} -1210 470 0 1 {name=V4 value="PULSE 0 1.8 20n 1n 1n 4n 10n"}
C {gnd.sym} -1210 520 0 0 {name=l21 lab=GND}
C {code_shown.sym} -1680 30 0 0 {name=s1 only_toplevel=false 
value=".control
tran 0.01n 300n
plot clk clk_g+2 x1b+4 q1b+6
.endc"}
